...
export function CivicAuthButton() {
  ...
  const handleClick = async () => {
    ...
    if (userContext.user && !userHasWallet(userContext)) {
      ...
      // If the user is authenticated and has a wallet, sign out
      connectWallet()
    }else{
      await signIn("iframe")
    }
  ...
  // If authenticated, has wallet, and isConnected, show action links instead of button
  ...
  console.log(user, hasWallet, isConnected)
